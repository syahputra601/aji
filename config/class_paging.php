...
if($halaman_aktif > 1){
	$prev = $halaman_aktif-1;
	$link_halaman .= "<a href=halkategori-$_GET[kt]-1.html class='nextprev'>Awal</a>
                    <a href=halkategori-$_GET[kt]-$prev.html class='nextprev'>Kembali</a>";
}
else{ 
$link_halaman .= "<span class='nextprev'>Awal</span>
<span class='nextprev'>Kembali</span>";
...
for ($i=$halaman_aktif-2; $i<$halaman_aktif; $i++){
  if ($i < 1)
  	continue;
	  $angka .= "<a href=halkategori-$_GET[kt]-$i.html>$i</a>";
  }
	 $angka .= " <span class='current'><b>$halaman_aktif</b></span>";
    ...
    if($i > $jmlhalaman)
	  ...
	  $angka .= ($halaman_aktif+2<$jmlhalaman ? "<span class='nextprev'>...</span><a href=halkategori-$_GET[kt]-$jmlhalaman.html>$jmlhalaman</a>" : " ");
...
if($halaman_aktif < $jmlhalaman){
	$next = $halaman_aktif+1;
	$link_halaman .= " <a href=halkategori-$_GET[kt]-$next.html class='nextprev' >Lanjut</a>
                     <a href=halkategori-$_GET[kt]-$jmlhalaman.html class='nextprev'>Akhir</a>";
}
else{
	$link_halaman .= "<span class='nextprev'>Lanjut</span>
	<span class='nextprev'>Akhir</span>";
...
if($halaman_aktif > 1){
	$prev = $halaman_aktif-1;
	$link_halaman .= "<a href=haltag-$_GET[idt]-1.html class='nextprev'>Awal</a>
                    <a href=haltag-$_GET[idt]-$prev.html class='nextprev'>Kembali</a>";
}
else{ 
$link_halaman .= "<span class='nextprev'>Awal</span>
<span class='nextprev'>Kembali</span>";
...
for ($i=$halaman_aktif-2; $i<$halaman_aktif; $i++){
  if ($i < 1)
  	continue;
	  $angka .= "<a href=haltag-$_GET[idt]-$i.html>$i</a>";
  }
	 $angka .= " <span class='current'><b>$halaman_aktif</b></span>";
    ...
    if($i > $jmlhalaman)
	  ...
	  $angka .= ($halaman_aktif+2<$jmlhalaman ? "<span class='nextprev'>...</span><a href=haltag-$_GET[idt]-$jmlhalaman.html>$jmlhalaman</a>" : " ");
...
if($halaman_aktif < $jmlhalaman){
	$next = $halaman_aktif+1;
	$link_halaman .= " <a href=haltag-$_GET[idt]-$next.html class='nextprev' >Lanjut</a>
                     <a href=haltag-$_GET[idt]-$jmlhalaman.html class='nextprev'>Akhir</a>";
}
else{
	$link_halaman .= "<span class='nextprev'>Lanjut</span>
	<span class='nextprev'>Akhir</span>";
...
if($halaman_aktif > 1){
	$prev = $halaman_aktif-1;
	$link_halaman .= "<a href=halaman-album-$_GET[ald]-1.html class='nextprev'>Awal</a> 
                    <a href=halaman-album-$_GET[ald]-$prev.html class='nextprev'>Kembali</a>";
}
else{ 
	$link_halaman .= "<span class='nextprev'>Awal</span> 
	<span class='nextprev'>Kembali</span>  ";
...
for ($i=$halaman_aktif-2; $i<$halaman_aktif; $i++){
  if ($i < 1)
    ...
    if($i > $jmlhalaman)
	  ...
	  $angka .= ($halaman_aktif+2<$jmlhalaman ? " <span class='nextprev'>...</span><a href=halaman-album-$_GET[ald]-$jmlhalaman.html>$jmlhalaman</a>" : " ");
...
if($halaman_aktif < $jmlhalaman){
	$next = $halaman_aktif+1;
	$link_halaman .= " <a href=halaman-album-$_GET[ald]-$next.html class='nextprev' >Lanjut</a>
                     <a href=halaman-album-$_GET[ald]-$jmlhalaman.html class='nextprev'>Akhir</a>";
}
else{
	$link_halaman .= "<span class='nextprev'>Lanjut</span>
	<span class='nextprev'>Akhir</span>";
