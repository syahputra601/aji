...
if (trim($_SESSION['leveluser'])==''){
  ...
  if($_SESSION['leveluser']=='user' OR $_SESSION['leveluser']=='admin'){
    $aksi="modul/mod_rekap_nilaipespel/aksi_rekap_nilaipespel.php";
        ...
        <div class='modal' style='width: 100%;'>
          ...
          <div class='modal-dialog modal-lg' style='width: 100%;'>
            ...
            <div class='modal-content' style='width: 100%;'>
              ...
              <form role='form' name='form1' action='$aksi?module=rekap_nilai&act=passing' method='post' enctype='multipart/form-data' onSubmit='return validasi()'>
